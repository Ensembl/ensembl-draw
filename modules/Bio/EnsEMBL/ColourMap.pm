...
sub new {
  ...
  $self->colourSet( 'vega_gene_corf',
    ...
    'superhi'                          => 'highlight2',
    'ccdshi'                           => 'lightblue1',
    'protein_coding'                   => [ 'olivedrab', 'Protein coding'],
    'processed_transcript'             => [ 'palegreen2', 'Novel Processed transcript' ],
  );
