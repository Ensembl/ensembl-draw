...
sub new {
  ...
  $self->colourSet( 'vega_gene_havana',
    ...
    'superhi'                          => 'highlight2',
    'ccdshi'                           => 'lightblue1',
    'protein_coding'                   => [ 'dodgerblue4', 'Protein coding'],
    'protein_coding_in_progress'       => [ 'dodgerblue4', 'Protein coding'],
    'polymorphic'                      => [ 'dodgerblue4', 'Protein coding'],
    'processed_transcript'             => [ 'skyblue3', 'Processed transcript'],
    'non_coding'                       => [ 'skyblue3', 'Processed transcript'],
    'pseudogene'                       => [ 'deeppink3', 'Pseudogene' ],
    'polymorphic_pseudogene'           => [ 'deeppink3', 'Pseudogene'],
    'processed_pseudogene'             => [ 'deeppink3', 'Pseudogene' ],
    'unprocessed_pseudogene'           => [ 'deeppink3', 'Pseudogene' ],
    'transcribed_pseudogene'           => [ 'deeppink3', 'Pseudogene' ],
    'unitary_pseudogene'               => [ 'deeppink3', 'Pseudogene' ],
    'transcribed_unprocessed_pseudogene' =>  [ 'deeppink3', 'Pseudogene' ],
    'transcribed_processed_pseudogene' =>  [ 'deeppink3', 'Pseudogene' ],
    'transcribed_unitary_pseudogene'   =>  [ 'deeppink3', 'Pseudogene' ],
    'IG_pseudogene'                    => [ 'deeppink3', 'Pseudogene' ],
    'IG_gene'                          => [ 'navy', 'IG gene' ],
  ...
  $self->colourSet( 'vega_gene_external',
    ...
    'superhi'                          => 'highlight2',
    'ccdshi'                           => 'lightblue1',
    'protein_coding'                   => [ 'orangered2', 'Protein coding'],
    'protein_coding_in_progress'       => [ 'orangered2', 'Protein coding'],
    'polymorphic'                      => [ 'orangered2', 'Protein coding'],
    'processed_transcript'             => [ 'lightsalmon2', 'Processed transcript'],
    'non_coding'                       => [ 'lightsalmon2', 'Processed transcript'],
    'polymorphic'                      => [ 'deeppink', 'Pseudogene'],
    'pseudogene'                       => [ 'deeppink', 'Pseudogene' ],
    'processed_pseudogene'             => [ 'deeppink', 'Pseudogene' ],
    'unprocessed_pseudogene'           => [ 'deeppink', 'Pseudogene' ],
    'transcribed_pseudogene'           => [ 'deeppink', 'Pseudogene' ],
    'unitary_pseudogene'               => [ 'deeppink', 'Pseudogene' ],
    'IG_pseudogene'                    => [ 'deeppink', 'Pseudogene' ],
    'IG_gene'                          => [ 'chocolate3', 'IG gene' ],
  ...
  $self->colourSet( 'clones',
    ...
    'lab_Unknown'     => 'black',
    'lab_'            => 'black',
    'col_conflict (tbc)'    => 'red',
    'col_consistent (tbc)'  => 'chartreuse3',
    'col_conflict'    => 'red',
