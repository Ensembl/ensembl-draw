...
sub my_label { 
  ...
  my $key = '_my_label';
  if( ! exists( $self->{$key} ) ){
    my $misc_set_code = $self->my_config('FEATURES'); # || die( "The FEATURES key of UserConfig must be a misc_set_code" );
    return undef unless $misc_set_code;
